package com.example.blurdialog.blurdialog;
...
import com.example.blurdialog.R;
import com.example.blurdialog.blurdialog.adapter.SingleSelectAdapter;
import com.example.blurdialog.blurdialog.blur.RoundRectBlurView;
import com.example.blurdialog.blurdialog.helper.BlurDialogHelper;
import com.example.blurdialog.blurdialog.listener.OnItemClick;
import com.example.blurdialog.blurdialog.listener.OnNegativeClick;
import com.example.blurdialog.blurdialog.listener.OnPositiveClick;
import com.example.blurdialog.blurdialog.view.DeterminateProgressView;
import com.example.blurdialog.blurdialog.view.IndeterminateProgressView;
...
public class BlurDialog {
    ...
    private void deleteStyle(Dialog dialog) {
        ...
        TextView vw_dialog_tv_ok = dialog.findViewById(R.id.vw_dialog_tv_ok);
        vw_dialog_tv_ok.setText("Delete");
        vw_dialog_tv_ok.setTextColor(R.color.colorAccent);
    }
